...
class Model: 
	...
	def __init__(self, charList, decoderType=DecoderType.BestPath, mustRestore=False, dump=False):
        ...
        # batch yada bir population üzerine normalleştirmenin kullanılıp kullanılmayacağı
	...
	def setupCNN(self): 
		"create CNN layers and return output of these layers" # CNN katmanlarını oluştur ve bu katmanların çıkışlarını döndür
	...
	def setupRNN(self):
		"create RNN layers and return output of these layers" #RNN katmanlarını oluştur ve bu katmanların çıkışlarını döndür
		rnnIn3d = tf.squeeze(self.cnnOut4d, axis=[2])

		# basic cells which is used to build RNN
        # RNN inşa edilirken kullanılan basit hücreler
		numHidden = 256
	...
	def setupCTC(self):
		...
		if self.decoderType == DecoderType.BestPath:
			...
			wordChars = open('../model/wordCharList.txt',encoding = "utf-8").read().splitlines()[0]
