...
def train(model, loader):
	...
	while True:
		...
		if charErrorRate < bestCharErrorRate:
			...
			model.save()
			open(FilePaths.fnAccuracy, 'w',encoding = "utf-8").write('Validation character error rate of saved model: %f%%' % (charErrorRate*100.0))
		else:
...
def main():
	...
	# infer text on test image
		...
		print(open(FilePaths.fnAccuracy,encoding = "utf-8").read())
